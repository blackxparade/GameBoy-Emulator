...
int CPU::RLC_0xcb_00(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(B);
  s = b.to_string();
  B = B << 1;
...
int CPU::RLC_0xcb_01(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(C);
  s = b.to_string();
  C = C << 1;
...
int CPU::RLC_0xcb_02(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(D);
  s = b.to_string();
  D = D << 1;
...
int CPU::RLC_0xcb_03(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(E);
  s = b.to_string();
  E = E << 1;
...
int CPU::RLC_0xcb_04(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(H);
  s = b.to_string();
  H = H << 1;
...
int CPU::RLC_0xcb_05(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(L);
  s = b.to_string();
  L = L << 1;
...
int CPU::RLC_0xcb_06(uint8_t n, uint8_t nn) {
  uint16_t HL = (uint16_t)(H << 8) | L;
  string s;
...
int CPU::RL_0xcb_10(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(B);
  s = b.to_string();
  B = B << 1;
...
int CPU::RL_0xcb_11(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(C);
  s = b.to_string();
  C = C << 1;
...
int CPU::RL_0xcb_12(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(D);
  s = b.to_string();
  D = D << 1;
...
int CPU::RL_0xcb_13(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(E);
  s = b.to_string();
  E = E << 1;
...
int CPU::RL_0xcb_14(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(H);
  s = b.to_string();
  H = H << 1;
...
int CPU::RL_0xcb_15(uint8_t n, uint8_t nn) {
  string s;
  bitset<8> b(L);
  s = b.to_string();
  L = L << 1;
...
int CPU::RL_0xcb_16(uint8_t n, uint8_t nn) {
  uint16_t HL = (uint16_t)(H << 8) | L;
  string s;
  bitset<8> b(intRAM[HL]);
  s = b.to_string();
  intRAM[HL] = intRAM[HL] << 1;
  intRAM[HL] = intRAM[HL] | FLAG[3];
